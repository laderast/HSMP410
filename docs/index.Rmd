...
This is a webpage describing the course material I have been developing for HMSP410, Health Informatics. They are intended for students with very little math and programming background. Where possible, I've tried to have hands-on activities for each of the subjects.
...
This is a brief introduction to genotyping and phenotyping through the lens of Genome Wide Association Studies. In the activity, students are given SNPs to explore using the EBI GWAS browser and we
